  ...
  <div class="container">
      ...
      <div class="card card-default card-borderless">
          <div class="card-body">
              ...
              <TodoListCopy :todoList="state.todoList" @delete-todo="deleteTodo"
              @toggle-completed="toggleCompleted"></TodoListCopy>
          </div>
      </div>
  </div>
</template>
...
export default{
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            state.todoList.push({ id: ts + 2, todo: "로스트아크 하기", completed: false });
